...
## Concept
Terraform compares desired configuration with state and provider APIs.

## Why it matters
State is critical infrastructure and must be protected, backed up and access-controlled.
