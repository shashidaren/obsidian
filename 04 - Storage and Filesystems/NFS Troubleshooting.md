...
## Concept
NFS failures may involve DNS, routing, firewall ports, identity mapping, server exports or storage latency.

## Why it matters
Distinguish mount problems from application I/O stalls.
