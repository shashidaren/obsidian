...
## Concept
Storage performance depends on workload, queueing, device characteristics and latency.

## Why it matters
High application latency can be caused by a small number of slow I/O operations.
