...
## Concept
A filesystem organizes data; a mount attaches it to the directory tree.

## Why it matters
Mount failures can arise from devices, filesystem corruption, `/etc/fstab`, credentials or network dependencies.
