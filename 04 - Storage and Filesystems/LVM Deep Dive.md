...
## Concept
LVM layers physical volumes into volume groups and logical volumes.

## Why it matters
It provides flexible allocation, but resizing and recovery must account for the filesystem above the LV.
