...
## Concept
Linux exposes storage as block devices which may contain partition tables, RAID members, LVM PVs or filesystems.

## Why it matters
Always identify the storage stack before changing it.
