...
## Concept
Major upgrades change repositories, libraries, defaults and sometimes boot behavior.

## Why it matters
Inventory dependencies and rehearse rollback or recovery before production migration.
