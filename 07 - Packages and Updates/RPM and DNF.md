...
## Concept
RHEL-family systems use RPM packages with DNF dependency and repository management.

## Why it matters
Understand repositories, transaction history, version locks and package signatures.
