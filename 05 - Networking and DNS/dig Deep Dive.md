...
## Concept
`dig` queries DNS and exposes records, authority and response details.

## Why it matters
It is excellent for DNS inspection but does not necessarily represent an application's complete resolver path.
