...
## Concept
Routing chooses the next hop based on destination and policy.

## Why it matters
Incorrect default routes and asymmetric paths commonly cause selective connectivity failures.
