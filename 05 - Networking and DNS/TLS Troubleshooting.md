...
## Concept
TLS failures may involve expiry, hostname mismatch, chain problems, protocol/cipher compatibility or application configuration.

## Why it matters
Use `openssl s_client` and application logs to inspect the negotiated path.
