...
## Concept
Unix access control combines ownership and rwx permissions; ACLs and mandatory access controls can add further restrictions.

## Why it matters
Permission errors require checking the whole access path, not just one file.
