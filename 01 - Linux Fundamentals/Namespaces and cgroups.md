...
## Concept
Namespaces isolate views of resources; cgroups account for and limit resources. Containers build heavily on both.

## Why it matters
Resource limits and isolation explain many container behaviours.
