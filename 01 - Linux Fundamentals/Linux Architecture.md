...
## Concept
Linux separates kernel space from user space. Applications normally request kernel services through system calls.

## Why it matters
Understand the boundary because failures can originate in applications, libraries, the kernel, drivers or hardware. The same symptom may appear at different layers.
