...
## Concept
A process is an executing program with resources such as address space and file descriptors. Threads share much of a process's context.

## Why it matters
High process count, blocked threads, file descriptor exhaustion and runaway workers are common production issues.
