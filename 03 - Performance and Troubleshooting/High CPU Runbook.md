...
## Concept
High CPU means sustained execution demand, but verify whether the host or a single process is constrained.

## Why it matters
Identify the workload, threads and recent change before restarting processes.
