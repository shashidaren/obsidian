...
## Concept
Pressure occurs when allocation and reclaim cannot keep up without unacceptable latency.

## Why it matters
Check available memory, swap activity, major faults and OOM evidence.
