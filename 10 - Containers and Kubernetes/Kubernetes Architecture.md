...
## Concept
Kubernetes separates desired state from reconciliation by control-plane and node components.

## Why it matters
Most troubleshooting starts by identifying whether the problem is scheduling, runtime, networking, configuration or storage.
