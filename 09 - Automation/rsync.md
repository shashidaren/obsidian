...
## Concept
rsync efficiently synchronizes directory trees.

## Why it matters
Understand deletion behavior, permissions, ownership and partial-transfer semantics before using it for production backups.
