...
## Concept
Ansible applies desired state from a control node using inventories, variables, modules, roles and playbooks.

## Why it matters
Idempotence and clear variable precedence reduce operational surprises.
