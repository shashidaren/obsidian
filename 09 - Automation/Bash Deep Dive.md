...
## Concept
Bash is powerful for orchestration but requires defensive practices around quoting, errors and input.

## Why it matters
Use strict modes thoughtfully and understand where shell semantics still require explicit checks.
