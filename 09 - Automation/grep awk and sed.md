...
## Concept
These tools search, transform and process text streams.

## Why it matters
Use the simplest tool that expresses the transformation clearly; avoid fragile parsing of human-oriented output.
