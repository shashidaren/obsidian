...
## Concept
The initramfs provides drivers and early userspace needed to locate and mount the real root filesystem.

## Why it matters
Missing storage, encryption or LVM components can prevent boot before normal services start.
