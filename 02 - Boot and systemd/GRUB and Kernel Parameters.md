...
## Concept
The bootloader selects a kernel and passes parameters that influence early kernel behavior.

## Why it matters
Temporary kernel parameters can aid recovery, but permanent changes should be documented and tested.
