...
## Concept
SELinux uses labels and policy to constrain processes beyond Unix permissions.

## Why it matters
Treat denials as evidence to understand, not a reason to permanently disable enforcement.
