...
## Concept
Reverse proxies terminate client connections and forward to upstream services.

## Why it matters
Timeouts, headers, health checks and connection pools are common failure points.
