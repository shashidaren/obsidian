...
## Concept
Administrators should understand connectivity, authentication, storage growth, backups, locks and slow queries.

## Why it matters
Never manipulate database files directly unless following database-specific recovery procedures.
