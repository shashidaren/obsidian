...
## Concept
For web services, separate listener, TLS, reverse proxy, upstream application and database layers.

## Why it matters
Local curl tests and socket inspection help identify where the request path fails.
